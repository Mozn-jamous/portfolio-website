    ...
    <section id="decisions" className="relative isolate scroll-mt-16 overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl px-5 py-10 sm:py-20 lg:px-8 lg:py-28">
        <Reveal>
          ...
          <h2 className="font-display mt-4 text-[1.55rem] font-medium leading-[1.24] tracking-normal sm:leading-[1.12] sm:tracking-tight text-[var(--ink)] sm:text-[2rem] lg:text-[2.75rem]">
