...
export const processContent = {
  ...
  intro:
    "I don't start with screens. I start with the problem — then take it all the way to production.",
  introAr:
    "لا أبدأ بالشاشات. أبدأ بالمشكلة — ثم آخذها حتى الإنتاج.",
  steps: [
    {
      step: "01",
      title: "Discover",
      titleAr: "اكتشاف",
      body: "Who has the problem, and what's at stake — before any UI.",
      bodyAr: "من يعاني المشكلة، وما المعرّض للخطر — قبل أي واجهة.",
    ...
    },
    {
      ...
      title: "Design",
      titleAr: "تصميم",
      body: "Architecture and tradeoffs first — structure before pixels.",
      bodyAr: "البنية والمفاضلات أولاً — الهيكل قبل البكسل.",
    ...
    },
    {
      ...
      title: "Build",
      titleAr: "بناء",
      body: "I build what I designed — front-end, backend, data model, and logic.",
      bodyAr: "أبني ما صمّمته — الواجهة، والخادم، ونموذج البيانات، والمنطق.",
    ...
    },
    {
      ...
      title: "Improve",
      titleAr: "تحسين",
      body: "Shipping is the start — access control, edge cases, and handover.",
      bodyAr: "الإطلاق هو البداية — التحكّم بالوصول، والحالات الحديّة، والتسليم.",
...
export const architectureStack: {
  ...
  intro:
    "Select a layer to see what's in it — and the product it came from. Every layer is something I've actually built.",
  introAr:
    "اختر طبقةً لترى ما فيها — والمنتج الذي جاءت منه. كل طبقة شيء بنيته فعلاً.",
  layers: [
    {
      id: "frontend",
      label: "Frontend",
